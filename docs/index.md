...
que se acierte el prompt**: con la misma variante Sonnet supera a Gemini por
+0.26 a +0.30 de F1, pero con la variante que le sirve al modelo más pequeño
...
| 4 | 2026-08-07 | Citas implícitas (exploratorio, n=7) | - | LLM detecta 5/7 vs clásico 2/7 |
