...
|---|---|---|---|---|
| 3 | 2026-07-02 | Multi-LLM (2 pasadas) | — | pipeline listo y validado (stub); comparación en vivo pendiente |
| 2 | 2026-07-02 | Salida rica v1 (spans + tipo) | — | pipeline listo y validado (stub); ver [ejemplo](https://github.com/mateoboerr/seminario_lunes/blob/main/results/ejemplo_v1.md) |
