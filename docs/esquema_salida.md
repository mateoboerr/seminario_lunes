...
La consigna puso especial énfasis en el **output** de la función. La meta es que se
...
[bitácora](experimentos.md#exp-2-salida-rica-v1-el-output-requerido)).
...
la consigna ("fijarse igual con el LLM").
