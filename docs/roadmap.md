...
## Qué se pidió (requerimientos del trabajo)
...
## Estado actual (avance al 2026-08-08)
...
- **Etapa 2 (salida rica v1) ✅ completa** Los dos modelos 16/16: span-F1 global
  **0.54** ambos, vs clásico **0.39**. Empatan en total pero no en detalle: Sonnet ubica mejor la fuente (0.27 vs 0.19), Gemini delimita mejor verbo y cita.
  [Exp 2](experimentos.md#exp-2-salida-rica-v1-el-output-requerido).
...
- **Citas implícitas (exploratorio) ✅** LLM detecta 5/7 débiles vs clásico 2/7
  (n bajo; el flag `explicita` del modelo casi no se usa). [Exp 4](experimentos.md#exp-4-citas-implícitas-exploratorio).
...
### Etapa 3, enfoque multi-LLM (experimento propuesto por la cátedra)
...
y se **documenta** en la Page con su número y su conclusión (qué funcionó, qué no).
